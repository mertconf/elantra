...
module.exports = {
  ...
  async execute(client, interaction, data) {
    ...
    return interaction.reply({ content: "Bu komut Elantra botuna özeldir. Kendi client'ınız üzerinde kullanmak için düzenleme yapmanız gerekir." });
    ...
    try {
      ...
      let destekSunucusuButon = new ButtonBuilder().setLabel('Destek Sunucusu').setURL("https://discord.gg/MXhDCCatvy").setStyle('Link');
      let davetBağlantısıButon = new ButtonBuilder().setLabel('Davet Bağlantısı').setURL(client.settings.invite).setStyle('Link');
      let sponsorButon = new ButtonBuilder().setLabel('Sponsor (gibir.net.tr)').setURL("https://gibir.net.tr/?utm_source=Elantra&utm_medium=buttons&utm_id=Elantra").setStyle('Link');
        ...
        switch (btn.customId) {
          ...
          case "usageStatsPageButton":
                ...
                embeds: [
                  {
                    ...
                    description: "🔒 Burası Lordestereol abime özeldir!"
                  }
                ],
                components: [
                  {
            ...
            for await (let guildData of guildDatas) {
              ...
              //Elantra ile Güçlendirilmiş Sunucular
              if (guildData.ElantraBoost?.users?.length) boostedGuilds++;
            ...
            for await (let userData of userDatas) {
              ...
              if (userData.ElantraPremium && (userData.ElantraPremium > Date.now())) premiumUsers++;
            }
              ...
              fields: [
                ...
                },
                {
                  ...
                  value:
                    ...
                    `**•** Elantra Premium Kullanıcıları: \`${premiumUsers}\`\n` +
                    `**•** Elantra ile Güçlendirilmiş Sunucular: \`${boostedGuilds}\``,
                },
              ],
            };
