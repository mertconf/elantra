...
module.exports = {
  ...
  async execute(client, interaction, data, args) {
    ...
    let fieldsLinks = {
      name: '**»** Bağlantılar',
      value: `**•** [Destek Sunucusu](https://discord.gg/MXhDCCatvy) • [Davet Bağlantısı](${client.settings.invite})`,
      inline: false
    };
    ...
    const embedMainPage = {
      ...
      description:
        ...
        `Bu bot [Elantra Açık Kaynak Projesi](https://discord.gg/MXhDCCatvy) ile oluşturulmuştur.`
        ...
        new Discord.StringSelectMenuBuilder()
          ...
          .addOptions([
            ...
            },
            {
              label: 'Bot Komutları',
              emoji: '🤖',
              description: 'Elantra ile ilgili komutlar.',
              value: 'botOption',
            },
          ])
      );
