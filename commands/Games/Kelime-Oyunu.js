...
module.exports = {
  ...
  async execute(client, interaction, data) {
    ...
    if (getCommand == "bilgi") {
      ...
      const destekSunucusuButon = new ButtonBuilder().setLabel('Destek Sunucusu').setURL("https://discord.gg/MXhDCCatvy").setStyle('Link');
        ...
        embeds: [
          {
            ...
            fields: [
              ...
              {
                name: '**»** Ekstra Bilgi',
                value: `**•** Kelime oyununun daha adil bir oyun olabilmesi adına bazı korumalar ekledik. Elantra, kelime oyununun sabote edildiğini fark ederse ilgili oyuncular hakkında ya da oyun üzerinde bazı aksiyonlar alabilir.`,
              },
              {
                name: '**»** Tüm Bunlara Rağmen Ben Anlamadım Arkadaş!',
                value: `**•** Aşağıdaki butondan gel [destek sunucumuza](https://discord.gg/MXhDCCatvy), yardımcı olalım. Aklına takılan nedir?`
              },
            ],
            image: {
      ...
      if (getCommand == "istatistikler") {
        ...
        let attachment = new Discord.AttachmentBuilder(
          ...
          { name: "Elantra-KelimeOyunuSiralamasi.txt" });
