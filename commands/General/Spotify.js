...
module.exports = {
  ...
  async execute(client, interaction, data, args) {
        ...
        embeds: [
          {
            ...
            description: `**•** Belki de durumunu gizlemiştir. Bilemeyiz... veya Seni Engellemiştir... Döveceksen yardıma gelelim hacı`
          }
        ]
      });
    }
    ...
    const file = new Discord.AttachmentBuilder(card, { name: "SpotifyCardCreatedByElantra.png" });
    const exampleEmbed = {
      ...
      image: {
        url: 'attachment://SpotifyCardCreatedByElantra.png',
      },
    };
