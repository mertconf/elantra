...
module.exports = {
  interaction: {
    name: "ayarlar",
    description: "Sunucunun Elantra ayarlarını gösterir.",
    options: []
  },
        ...
        embeds: [
          {
            ...
            description:
              ...
              `**•** Bir sorun olduğunu düşünüyorsanız [destek sunucumuza](https://discord.gg/MXhDCCatvy) gelebilirsiniz.`
          }
        ],
        components: [
          {
            type: 1, components: [
              new ButtonBuilder().setLabel('Destek Sunucusu').setURL("https://discord.gg/MXhDCCatvy").setStyle('Link')
            ]
          },
        ]
      });
              ...
              fields: [
                {
                  ...
                  value:
                    ...
                    `**•** Roller: ${spamProtection?.exempts?.roles?.length > 0
                      ...
                      : `\`Muaf rol yok\``}\n` +
                    `**•** Ek: \`"Mesajları Yönet" yetkisine sahip üyeler\`, \`Elantra'nin zaman aşımı veremeyeceği üyeler\``
                },
              ],
            }
          ],
