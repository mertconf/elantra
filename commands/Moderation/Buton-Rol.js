    ...
    if (getCommand == "bilgi") {
      ...
      if (Object.keys(data.guild.buttonRole || {}).length >= 50)
        return interaction.reply({
          ...
          components: [
            {
              type: 1, components: [new Discord.ButtonBuilder().setLabel('Destek Sunucusu').setURL(`https://discord.gg/MXhDCCatvy`).setStyle('Link')]
            },
          ]
        });
          ...
          embeds: [
            {
              ...
              description:
                ...
                `**•** "Nasıl yapacağım anlamadım ki?" diyorsan [destek sunucumuza](https://discord.gg/MXhDCCatvy) katılabilirsin.`
            }
          ],
          components: [
            {
              type: 1, components: [new ButtonBuilder().setLabel('Destek Sunucusu').setURL("https://discord.gg/MXhDCCatvy").setStyle('Link')]
            },
          ]
        });
