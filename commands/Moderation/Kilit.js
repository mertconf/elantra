...
module.exports = {
  ...
  async execute(client, interaction, data) {
    ...
    const destekSunucusuButton = new ButtonBuilder().setLabel('Destek Sunucusu').setURL("https://discord.gg/MXhDCCatvy").setStyle('Link')
        ...
        embeds: [
          {
            ...
            description: `**•** Herhangi bir sorun yaşarsan Elantra'den destek alabilirsin.`,
          }
        ],
        components: [
          {
